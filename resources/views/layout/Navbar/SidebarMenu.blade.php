...
@if (Auth::guard('admin')->check())
    ...
    <aside class="app-sidebar">
        <div class="app-sidebar__user"><img class="app-sidebar__user-avatar"
                src="{{ URL::asset('resources/css_js_admin/') }}/images/img_avatar.png" style="width: 100px"
                alt="User Image">
            <div>
    ...
    <ul class="app-menu">
        <li><a class="app-menu__item active" href="{{ url('/admin/dashboard') }}"><i
            ...
            <li><a class="app-menu__item active" href="{{ url('/nha_san_xuat/xem_nha_san_xuat') }}"><i
                        class="app-menu__icon fa fa-building-o"></i><span class="app-menu__label">Nhà sản
                        xuất</span></a>
            </li>
            <hr>
            <li><a class="app-menu__item active" href="{{ url('/hoa_don/xem_hoa_don') }}"><i fa fa-university
                        class="app-menu__icon fa fa-credit-card-alt"></i><span class="app-menu__label">Hóa 
                        Đơn</span></a>
            </li>
            <li><a class="app-menu__item active" href="{{ url('/phieu_thu/xem_phieu_thu') }}"><i fa fa-university
                        class="app-menu__icon fa fa-credit-card-alt"></i><span class="app-menu__label">Phiếu
                        thu</span></a>
            </li>
            ...
            <li class="treeview"><a class="app-menu__item" href="#" data-toggle="treeview"><i
                ...
                <ul class="treeview-menu">
                    <li><a class="treeview-item" href="{{ url('/nhan_vien/xem_nhan_vien') }}"><i
                                class="icon fa fa-user"></i>Nhân viên </a></li>
                    <li><a class="treeview-item" href="{{ url('/khach_hang/xem_khach_hang') }}"><i
                                class="icon fa fa-users"></i>Khách Hàng</a></li>
