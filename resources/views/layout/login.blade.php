     ...
     <div class="container">
         <div class="row">
            <div class="col-md-3">
             ...
             <div class="col-md-6">
                <div class="login-box" style="border-radius: 2%" >
                    <form class="login-form"action="{{URL::to('/login-admin')}}" method="post" >
                    {{ csrf_field() }} <!--Chống injection-->
                      <h3 class="login-head">Sign In</h3>
                      <div class="form-group">
                        <label class="control-label">Email or Username</label>
                        <input class="form-control" type="text" placeholder="Enter Username or Email" name="adminEmail" autofocus>
                        <p class="help is-danger" style="color:red">{{ $errors->first('adminEmail') }}</p>
                      </div>
                      <div class="form-group">
                        <label class="control-label">PASSWORD</label>
                        <input class="form-control" type="password"  name="adminPass" placeholder="Enter Password">
                      ...
                      <div class="form-group btn-container">
                        <button class="btn btn-success btn-block"><i class="fa fa-sign-in fa-lg fa-fw "></i>Login now</button>
                      </div>
                    </form>
