            ...
            <div class="col-sm-12 col-md-10 col-md-offset-1">
                ...
                <div class="container" style="margin-top: 100px">
                    <div class="check-out">
                        ...
                        <p class="noItemCart">Bạn chưa có sản phẩm nào trong giỏ hàng.<br>Click<a href="{{URL::to('/')}}"> vào đây</a> để mua sắm</p>
                    </div>
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td class="col-sm-8 col-md-8">
                                    <div class="media">
                                        <a class="thumbnail pull-left" href="#"> <img class="media-object" src="{{ URL::asset('resources/css_js_user/') }}/images/{{$cart_pro->options->image}}" style="height: 100px;"></a>
                                        <div class="media-body">
                                            <h4 class="media-heading cart_name_pro"><a href="">{{$cart_pro->name}}</a>
                                            </h4>
                                            <h5 class="media-heading"> NSX: <a href="#">{{$cart_pro->options->brand}}</a></h5>
                        ...
                        <tfoot>
                            ...
                            <tr>
                                <td>
                                    ...
                                    <a href="#my-modal" data-toggle="modal" class="btn btn-danger" role="button" style="display: flex; width: 110px;"><i class="fa fa-trash text" style="color:#ffffff"></i><span class="fa fa-times"></span> Xóa tất cả</a>
                                                ...
                                                <div class="modal-body p-0">
                                                    <div class="card border-0 p-sm-3 p-2 justify-content-center">
                                                        <div class="card-header pb-0 bg-white border-0 ">
                                                            ...
                                                            <div class="row">
                                                                <div class="col ml-auto"><button type="button" class="close btnClose" data-dismiss="modal" aria-label="Close"> <span aria-hidden="true">&times;</span> </button>
                                                        ...
                                                        <div class="card-body px-sm-4 mb-2 pt-1 pb-0">
                                                            ...
                                                            <div class="row justify-content-end no-gutters">
                                                                <div class="col-auto" style="float:right; margin-right:20px">
                                                                    ...
                                                                    <button type="button" class="btn btn-danger px-4"><a class="btnDeleteUser" style="color: #fff; text-decoration: none;" href="{{URL::to('/delete-item-cart')}}">Delete</a></button>
                                                                </div>
                            ...
                            <tr>
                                <td colspan="5">
                                    <h5>Tiếp Tục Mua Sắm ?</h2><a href="{{url('/')}}" style="font-weight: bold;">Click</a>
                                </td>
                            </tr>
                        </tfoot>
                    </table>
