...
<body class="app sidebar-mini">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <form action="{{ URL('phieu_thu/sua_phieu_thu')}}/{{$pt->MaPT}}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="col-lg-12">
                                <h6 style="text-align: center">Ngày thu tiền:<input name="ngaythu" type="date" required value={{$pt->NgayTT->format('Y-m-d')}}></h6>
                            </div>
                            <hr>
                            <h6>Mã Phiếu:<input name="mapt" type="text" readonly value="{{$pt->MaPT}}"></h6>
                            <h6>Mã Nhân viên:<input  name="manv" type="text" readonly  value="{{$pt->MaNV}}"></h6>
                            <h6 style="text-align: right">Mã Hóa Đơn:<input type="text" name="mahd" readonly  value="{{$pt->MaHD}}"></h6>
                            <hr>
                            <div class="tile">
                                <div class="tile-body">
                                    <div class="col-lg-12">
                                        <h5>Số tiền thu:<input type="text" name="tienthu" id="tienmoi" value="{{$pt->SoTienTT}}" onkeyup="tinhno()"></h5>
                                        <input type="text" id="tiencu"  value="{{$pt->SoTienTT}}" hidden></h5>
                                        <h5 >Thu tiền đợt:<input type="text" name="thutiendot" value="{{$pt->Dot}}"></h5>
                                        <h5>Công Nợ:<input type="text" id="congno" name="congno"  value="{{$pt->CongNo}}" readonly></h5>
                                    ...
                                    <div class="col-lg-12">
                                        <h6 style="text-align: right">Trạng thái:<input  type="checkbox" id="trangthai"  {{$pt->TrangThai==1? ' checked' : ''}}></h6>
                                    </div>
                            ...
                            <div class="tile-footer">
                              ...
                              style="background-color: darkblue">Sửa</button>
                                &ensp; <a class="btn btn-primary" type="submit"
                                    href="{{url('phieu_thu/xem_phieu_thu')}}" style="background-color:violet">Quaylại</a>
                            </div>
                        </form>
                    </div>
    ...
    <script>
        ...
        function tinhno() {
            ...
            {
                alert('Kiểm tra lại số tiền nhập')
