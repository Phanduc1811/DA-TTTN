                ...
                <table class="table table-hover table-bordered" id="sampleTable">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td></td>
                      <td>
                        <a href="{{url('/vat_tu/chi_tiet_vat_tu')}}"><i class="fa fa-list" style=" font-size : 30px"></i></a>&ensp;&ensp;
                        <a href=""><i class="fa fa-trash" style=" font-size : 30px"></i></a>&ensp;&ensp;
                        <a href="{{url('/vat_tu/sua_vat_tu')}}"><i class=" fa fa-wrench" style=" font-size : 30px"></i></a>
                      </td>
                    </tr>
                  </tbody>
                </table>
