                        ...
                        <table class="table table-hover table-bordered" id="sampleTable">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{ $vt->SoLuong }}</td>
                                    <td>
                                        <a href="{{ url('/vat_tu') }}/{{ $vt->MaVT }}"><i class="fa fa-list" style=" font-size : 30px"></i></a>&ensp;&ensp;
                                        <a href="#my-modal_{{$vt->MaVT}}" data-toggle="modal" role="button"><i class="fa fa-trash" style=" font-size : 30px"></i></a>&ensp;&ensp;
                                        <a href="{{ url('/vat_tu/sua_vat_tu')}}/{{$vt->MaVT}}"><i class=" fa fa-wrench" style=" font-size : 30px"></i></a>

                                        <!-- Modal  -->
                                        <div id="my-modal_{{$vt->MaVT}}" class="modal fade" tabindex="-1" role="dialog" aria-hidden="true">
                                                            ...
                                                            <div class="card-body px-sm-4 mb-2 pt-1 pb-0">
                                                                ...
                                                                <div class="row justify-content-end no-gutters">
                                                                    <div class="col-auto" style="float:right; margin-right:20px">
                                                                        ...
                                                                        <button type="button" class="btn btn-danger px-4"><a class="btnDeleteUser" href="{{url('/vat_tu/destroy')}}/{{$vt->MaVT}}" style="color: #fff">Delete</a></button>
                                                                    </div>
