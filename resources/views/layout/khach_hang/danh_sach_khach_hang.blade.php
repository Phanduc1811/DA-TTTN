                ...
                <table class="table table-hover table-bordered" id="sampleTable">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td>
                        <a href="{{url('/khach_hang/chi_tiet_khach_hang')}}"><i class="fa fa-list" style=" font-size : 30px"></i></a>&ensp;&ensp;
                        <a href=""><i class="fa fa-trash" style=" font-size : 30px"></i></a>&ensp;&ensp;
                        <a href="{{url('/khach_hang/sua_khach_hang')}}"><i class=" fa fa-wrench" style=" font-size : 30px"></i></a>
                      </td>
                    </tr>
                  </tbody>
                </table>
