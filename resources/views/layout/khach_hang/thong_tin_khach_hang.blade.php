                        ...
                        <div class="tile">
                            ...
                            @foreach($edit_cus as $key => $cus)
                                ...
                                <div class="tile-footer">
                                    <button class="btn btn-primary" onclick="window.location='{{ url('/khach_hang/sua_khach_hang/'.$cus->MaKH) }}'" type="submit" style="background-color: darkblue">Sửa</button>
                                    &ensp; <button class="btn btn-primary"onclick="window.location='{{ url()->previous() }}'" type="submit" style="background-color:violet">Quay
                                        lại</button>
                                </div>
                            @endforeach
                            </div>
