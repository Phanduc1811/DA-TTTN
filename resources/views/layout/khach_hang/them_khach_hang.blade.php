                        ...
                        {!! csrf_field() !!}
                            <div class="form-group">
                                ...
                                <input class="form-control" id="exampleInputEmail1" type="text"
                                    aria-describedby="emailHelp" placeholder="Mã khách hàng" required name="customer_id">
                            </div>
                            <div class="form-group">
                                <label for="exampleInputEmail1">Tên Khách hàng</label>
                                <input class="form-control" id="exampleInputEmail1" type="text"
                                    aria-describedby="emailHelp" placeholder="Tên khách hàng" required name="customer_name">
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" id="exampleInputEmail1" type="text"
                                    aria-describedby="emailHelp" required placeholder="Địa chỉ" required name="address">
                            </div>
                            <div class="form-group">
                                <label for="exampleInputEmail1">Số Điện thoại</label>
                                <input class="form-control" id="exampleInputEmail1" type="number"
                                    aria-describedby="emailHelp" required placeholder="Số điện thoại" name="customer_phone">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="tile-footer">
                                <button class="btn btn-primary" type="submit"
                                    style="background-color: darkblue">Tạo</button> &ensp; 
                                    <button class="btn btn-primary" type="reset" style="background-color: red">Xóa</button>
                            </div>
                        </form> 
                    </div>
                </div>
